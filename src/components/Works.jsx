    ...
    <motion.div variants={fadeIn("up","spring",index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
          <div onClick={() => window.open(source_code_link, "_black")} className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer">
        ...
        <div className="mt-5">
         ...
         <p className="text-secondary text-semibold text-[14px]">{description}</p>
        </div>
  ...
  return (
    <>
       <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>What's My Project?</p>
