    ...
    <div className="mt-1">
      ...
      <div className="mt-7 flex justify-between items-center gap-1">
        <div className="flex-1 flex flex-col">
          ...
          <p className="mt-1 text-white text-[12px] text-semibold">
    ...
    <div className="mt-12 bg-black-100 rounded-[20px]">
      <div className={`${styles.padding} bg-tertiary rounded-2xl min-h-[300px]`}>
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubText}>What's People Say About Me</p>
          <h2 className={styles.sectionHeadText}>Feedbacks</h2>
        </motion.div>
      </div>
      <div className={`${styles.paddingX} -mt-20 justify-between pb-14 flex items-center flex-wrap gap-7`}>
